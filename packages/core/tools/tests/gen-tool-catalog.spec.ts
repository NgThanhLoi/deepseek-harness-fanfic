...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual(['anti_copy_guard', 'ask_user_question', 'author_context', 'bash', 'bash', 'canon_causality_trace', 'canon_chapter_read', 'canon_context_expand', 'canon_enrichment_checkpoint', 'canon_enrichment_commit', 'canon_enrichment_plan', 'canon_enrichment_progress', 'canon_enrichment_validate', 'canon_search', 'canon_snapshot', 'canon_timeline_context', 'character_intelligence', 'character_voice_context', 'cordis_define', 'cordis_inspect_list', 'cordis_inspect_query', 'cordis_inspect_self', 'cordis_run', 'cordis_stop', 'cordis_undefine', 'create_goal', 'edit', 'exit_plan_mode', 'fanfic_apply_delta', 'fanfic_audit', 'fanfic_branch_create', 'fanfic_branch_get', 'fanfic_branch_list', 'fanfic_chapter_state', 'fanfic_divergence_record', 'fanfic_draft_get', 'fanfic_draft_stage', 'fanfic_draft_update', 'fanfic_impact_scan', 'fanfic_intent_update', 'fanfic_prepare_chapter', 'fanfic_review_draft', 'fanfic_status', 'fanfic_style_audit', 'fanfic_worker_status', 'get_goal', 'glob', 'grep', 'interrupt_agent', 'invention_upsert', 'job_kill', 'job_list', 'job_output', 'list_agents', 'lsp', 'mystery_truth_upsert', 'narrative_style_context', 'power_assess', 'pwsh', 'ralph', 'read', 'read_image', 'report', 'run_code', 'schedule_create', 'schedule_delete', 'schedule_list', 'send_message', 'session_event_read', 'session_event_search', 'session_event_trace', 'session_search', 'session_trace', 'skill', 'story_arc_upsert', 'story_director_context', 'story_foreshadow_upsert', 'story_horizon_set', 'story_reconciliation_resolve', 'story_thread_upsert', 'str_replace_editor', 'subagent', 'terminal_close', 'terminal_list', 'terminal_open', 'terminal_read', 'terminal_send', 'terminal_signal', 'todo_write', 'update_goal', 'web_fetch', 'web_search', 'workflow', 'write'])
