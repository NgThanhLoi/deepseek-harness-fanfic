...
export class FanficRuntime extends Service {
  ...
  private provider(): FanficProvider {
    ...
    if (selected === undefined) {
      throw new FanficError('no usable fanfic provider is registered', 'FANFIC_PROVIDER_UNAVAILABLE')
    }
    return selected
  }
   ...
   */
  search(
    request: CanonSearchRequest,
    signal?: AbortSignal,
  ): Promise<readonly CanonSearchHit[]> {
   ...
   */
  readChapter(
    request: CanonChapterReadRequest,
    signal?: AbortSignal,
  ): Promise<CanonChapter> {
    return this.provider().readChapter(request, signal)
  }
  /**
  ...
  authorContext(
    ...
    return this.provider().authorContext(request, signal)
  }
  /**
   ...
   */
  traceCausality(
    request: CanonCausalityTraceRequest,
    signal?: AbortSignal,
  ): Promise<CanonCausalityTrace> {
    return this.provider().traceCausality(request, signal)
  }
  /**
   ...
   */
  timelineContext(
    request: CanonTimelineContextRequest,
    signal?: AbortSignal,
  ): Promise<CanonTimelineContext> {
    return this.provider().timelineContext(request, signal)
  }
  /**
   ...
   */
  expandContext(
    request: CanonContextExpansionRequest,
    signal?: AbortSignal,
  ): Promise<CanonContextExpansion> {
    return this.provider().expandContext(request, signal)
  }
  /**
   ...
   */
  characterIntelligence(
    request: CharacterIntelligenceRequest,
    signal?: AbortSignal,
  ): Promise<CharacterIntelligence> {
    return this.provider().characterIntelligence(request, signal)
  }
  /**
  ...
  characterVoiceContext(
    ...
    signal?: AbortSignal,
  ): Promise<CharacterVoiceContext> {
    return this.provider().characterVoiceContext(request, signal)
  }
  /**
   ...
   */
  narrativeStyleContext(
    request: NarrativeStyleContextRequest,
    signal?: AbortSignal,
  ): Promise<NarrativeStyleContext> {
    return this.provider().narrativeStyleContext(request, signal)
  }
  /**
   ...
   */
  antiCopyGuard(
    request: AntiCopyGuardRequest,
    signal?: AbortSignal,
  ): Promise<AntiCopyGuardResult> {
    return this.provider().antiCopyGuard(request, signal)
  }
  /**
   ...
   */
  auditNarrativeStyle(
    request: NarrativeStyleAuditRequest,
    signal?: AbortSignal,
  ): Promise<NarrativeStyleAuditResult> {
    return this.provider().auditNarrativeStyle(request, signal)
  }
  /**
  ...
  assessPower(
    ...
    signal?: AbortSignal,
  ): Promise<PowerAssessment> {
    return this.provider().assessPower(request, signal)
  }
  /**
   ...
   */
  impactScan(
    request: FanficImpactScanRequest,
    signal?: AbortSignal,
  ): Promise<FanficImpactScan> {
    return this.provider().impactScan(request, signal)
  }
  /**
  ...
  validateEnrichment(
    ...
    signal?: AbortSignal,
  ): Promise<CanonEnrichmentValidation> {
    return this.provider().validateEnrichment(candidate, signal)
  }
  /**
   ...
   */
  commitEnrichment(
    request: CanonEnrichmentCommitRequest,
    signal?: AbortSignal,
  ): Promise<CanonEnrichmentCommitResult> {
    return this.provider().commitEnrichment(request, signal)
  }
  /**
   ...
   */
  planEnrichment(
    request: CanonEnrichmentPlanRequest,
    signal?: AbortSignal,
  ): Promise<CanonEnrichmentPlan> {
    return this.provider().planEnrichment(request, signal)
  }
  /**
   ...
   */
  enrichmentProgress(
    request: CanonEnrichmentProgressRequest,
    signal?: AbortSignal,
  ): Promise<CanonEnrichmentProgress> {
    return this.provider().enrichmentProgress(request, signal)
  }
  /**
   ...
   */
  checkpointEnrichment(
    request: CanonEnrichmentCheckpointRequest,
    signal?: AbortSignal,
  ): Promise<CanonEnrichmentCoverage> {
    return this.provider().checkpointEnrichment(request, signal)
  }
  /**
   ...
   */
  createBranch(
    request: CreateFanficBranchRequest,
    signal?: AbortSignal,
  ): Promise<FanficBranch> {
    return this.provider().createBranch(request, signal)
  }
  /**
   ...
   */
  recordDivergence(
    request: RecordFanficDivergenceRequest,
    signal?: AbortSignal,
  ): Promise<FanficBranch> {
    return this.provider().recordDivergence(request, signal)
  }
  /**
   ...
   */
  updateIntent(
    request: UpdateFanficIntentRequest,
    signal?: AbortSignal,
  ): Promise<FanficBranch> {
    return this.provider().updateIntent(request, signal)
  }
  /**
   ...
   */
  updateStoryDirector(
    request: UpdateFanficStoryDirectorRequest,
    signal?: AbortSignal,
  ): Promise<FanficBranch> {
    return this.provider().updateStoryDirector(request, signal)
  }
  /**
   ...
   */
  upsertStoryArc(
    request: UpsertFanficStoryArcRequest,
    signal?: AbortSignal,
  ): Promise<FanficBranch> {
    return this.provider().upsertStoryArc(request, signal)
  }
  /**
   ...
   */
  upsertStoryThread(
    request: UpsertFanficStoryThreadRequest,
    signal?: AbortSignal,
  ): Promise<FanficBranch> {
    return this.provider().upsertStoryThread(request, signal)
  }
  /**
   ...
   */
  upsertForeshadow(
    request: UpsertFanficForeshadowRequest,
    signal?: AbortSignal,
  ): Promise<FanficBranch> {
    return this.provider().upsertForeshadow(request, signal)
  }
  /**
   ...
   */
  setStoryHorizon(
    request: SetFanficHorizonRequest,
    signal?: AbortSignal,
  ): Promise<FanficBranch> {
    return this.provider().setStoryHorizon(request, signal)
  }
  /**
   ...
   */
  upsertMysteryTruth(
    request: UpsertFanficMysteryTruthRequest,
    signal?: AbortSignal,
  ): Promise<FanficBranch> {
    return this.provider().upsertMysteryTruth(request, signal)
  }
  /**
   ...
   */
  upsertInvention(
    request: UpsertFanficInventionRequest,
    signal?: AbortSignal,
  ): Promise<FanficBranch> {
    return this.provider().upsertInvention(request, signal)
  }
  /**
  ...
  resolveDirectorReconciliation(
    ...
    return this.provider().resolveDirectorReconciliation(request, signal)
  }
  /**
   ...
   */
  storyDirectorContext(
    request: StoryDirectorContextRequest,
    signal?: AbortSignal,
  ): Promise<StoryDirectorContext> {
    return this.provider().storyDirectorContext(request, signal)
  }
  /**
   ...
   */
  applyDelta(
    request: ApplyFanficDeltaRequest,
    signal?: AbortSignal,
  ): Promise<FanficBranch> {
    return this.provider().applyDelta(request, signal)
  }
  /**
