...
Source: [`packages/fanfic/fanfic/src/index.ts:89`](../packages/fanfic/fanfic/src/index.ts)
...
Source: [`packages/fanfic/fanfic-local/src/index.ts:9`](../packages/fanfic/fanfic-local/src/index.ts)
...
Requires: `fanfic` · `tools` · `systemPrompt`
