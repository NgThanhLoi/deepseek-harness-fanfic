...
| [fanfic.md](fanfic.md) | the opt-in fanfic authoring seam: provider registration/dispatch, the dual canon/branch cutoffs, verified enrichment, Story Director metadata, and transactional chapter settlement |
